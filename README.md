...
Welcome to *Practical Deep Learning for Coders*. This web site covers the book and the course, which are designed to work closely together. If you haven't yet go the book, you can [buy it here](https://www.amazon.com/Deep-Learning-Coders-fastai-PyTorch/dp/1492045527). It's also freely available as interactive Jupyter Notebooks; read on to learn how to access them.
